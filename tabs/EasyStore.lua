...
function EasyStore:draw()
    ...
    textMode (CENTER)
    pushStyle ()
    text("Easy World Store", WIDTH/2, HEIGHT-100)
    goBackButton:draw()
    ...
    for i= 1,10 do
        ...
        sprite("Dropbox:lock", buttonPos[i].x, buttonPos[i].y, 150, 110)
        end
    end
end

function EasyStore:touched(touch)
    -- Codea does not automatically call this method
